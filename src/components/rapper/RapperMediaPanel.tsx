...
export function RapperMediaPanel({
  ...
  return (
    <section className="relative aspect-[3/4] h-full min-h-[420px] overflow-hidden rounded-lg border border-white/10 bg-black md:min-h-[560px] xl:aspect-auto xl:min-h-0">
